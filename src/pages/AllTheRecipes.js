...
const AllTheRecipes = () => {
  ...
  useEffect(() => {
    axios.get(`${env.BACKEND_URL}/recipe/all/${userId}`).then((response) => {
  ...
  useEffect(() => {
    if (categId) {
      axios
        .get(`${env.BACKEND_URL}/category/${userId}/${categId}/recipes`)
        .then((response) => {
                    ...
                    return (
                      <div key={i} className="recipe">
                        <button
                          ...
                          onClick={() => {
                            axios.delete(
                              `${env.BACKEND_URL}/recipe/${recipe.id}`
                            );
